...
const FEATURES = Object.freeze({
  "cf-agentic-underwriting-automation-handling": "Agentic Underwriting Automation Handling",
  "cf-customer-risk-trajectory-modeling-over-p": "Customer Risk Trajectory Modeling Over P",
  "cf-fraud-syndicate-detection-correlating-ap": "Fraud Syndicate Detection Correlating Ap",
  "cf-premium-dynamism-recommending-real-time-": "Premium Dynamism Recommending Real Time ",
  "cf-renewals-optimization-predicting-likelih": "Renewals Optimization Predicting Likelih",
  "cf-rule-engine-optimization-recommending-up": "Rule Engine Optimization Recommending Up",
  "gap-live-rating-bureau-integration-still-sca": "Live Rating Bureau Integration Still Sca",
  "gap-no-ai-premium-rate-recommender": "No Ai Premium Rate Recommender",
  "gap-no-e-signature-for-binderspolicies": "No E Signature For Binderspolicies",
  "gap-no-file-upload-for-supporting-documents": "No File Upload For Supporting Documents",
  "gap-no-fraud-probability-ai": "No Fraud Probability Ai",
  "gap-no-policy-recommendation-engine": "No Policy Recommendation Engine",
  "gap-no-renewal-prediction-model": "No Renewal Prediction Model",
  "gap-no-risk-score-endpoint-backed-by": "No Risk Score Endpoint Backed By",
  "gap-no-rule-optimization-analyzer": "No Rule Optimization Analyzer",
  "gap-no-webhook-surface-for-application-event": "No Webhook Surface For Application Event",
});
