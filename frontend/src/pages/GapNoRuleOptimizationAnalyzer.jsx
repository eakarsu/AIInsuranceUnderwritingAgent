...
// Auto-generated page for: No rule-optimization analyzer

export default function GapNoRuleOptimizationAnalyzer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-rule-optimization-analyzer', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No rule-optimization analyzer</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No rule-optimization analyzer</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No rule-optimization analyzer'}
        </button>
      </form>
