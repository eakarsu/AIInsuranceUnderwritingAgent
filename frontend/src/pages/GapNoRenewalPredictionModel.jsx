...
// Auto-generated page for: No renewal-prediction model

export default function GapNoRenewalPredictionModel() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-renewal-prediction-model', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No renewal-prediction model</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No renewal-prediction model</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No renewal-prediction model'}
        </button>
      </form>
