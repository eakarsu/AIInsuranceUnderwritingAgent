...
// Auto-generated page for: Fraud syndicate detection correlating applications across ag

export default function CfFraudSyndicateDetectionCorrelatingAp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-fraud-syndicate-detection-correlating-ap', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Fraud syndicate detection correlating applications across ag</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Fraud syndicate detection correlating applications across agents/brokers.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Fraud syndicate detection correlating applications across ag'}
        </button>
      </form>
