...
// Auto-generated page for: Customer risk trajectory modeling over policy lifetime

export default function CfCustomerRiskTrajectoryModelingOverP() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-customer-risk-trajectory-modeling-over-p', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Customer risk trajectory modeling over policy lifetime</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Customer risk trajectory modeling over policy lifetime.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Customer risk trajectory modeling over policy lifetime'}
        </button>
      </form>
