...
// Auto-generated page for: No e-signature for binders/policies

export default function GapNoESignatureForBinderspolicies() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-e-signature-for-binderspolicies', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No e-signature for binders/policies</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No e-signature for binders/policies</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No e-signature for binders/policies'}
        </button>
      </form>
