...
const features = [
  ...
  { slug: 'quote-bind-issue', title: 'Quote Bind Issue', desc: 'Track quote-to-bind-to-issue stages, underwriter assignment, and bind deadlines', icon: 'QBI', color: '#2b6cb0', badge: 'core', api: '/quote-bind-issue' },
  { slug: 'billing-payments', title: 'Billing & Payments', desc: 'Manage premium invoices, payments, collections, and transaction references', icon: 'PAY', color: '#2f855a', badge: 'core', api: '/billing-payments' },
  { slug: 'endorsements', title: 'Endorsements', desc: 'Manage policy changes, premium deltas, approvals, and issuance status', icon: 'END', color: '#6b46c1', badge: 'core', api: '/endorsements' },
  { slug: 'cancellations', title: 'Cancellations', desc: 'Run cancellation workflows with retention actions, refunds, and effective dates', icon: 'CAN', color: '#c53030', badge: 'core', api: '/cancellations' },
  { slug: 'esignature-packets', title: 'E-Signature', desc: 'Track signature packets for applications, binders, endorsements, and policy forms', icon: 'SIG', color: '#744210', badge: 'core', api: '/esignature-packets' },
  { slug: 'rbac-admin', title: 'RBAC Admin', desc: 'Review roles, permission scopes, MFA status, approvers, and access certifications', icon: 'RBAC', color: '#1a365d', badge: 'core', api: '/rbac-admin' },
  { slug: 'audit-exports', title: 'Audit Exports', desc: 'Prepare regulator and model-governance export packages with delivery tracking', icon: 'EXP', color: '#4a5568', badge: 'analytics', api: '/audit-exports' },
  ...
  { slug: '__customer-portal', title: 'Customer Portal', desc: 'Customer quote intake, active policies, and quote history tied to seeded PostgreSQL customers', icon: '👤', color: '#2f855a', badge: 'core', route: '/customer-portal' },
  { slug: '__agent-portal', title: 'Agent Portal', desc: 'Producer book of business, commission estimates, and lead pipeline actions', icon: '🏢', color: '#2a4365', badge: 'core', route: '/agent-portal' },
  { slug: '__uw-workflow', title: 'UW Workflow', desc: 'Stage-based underwriting queue with intake, review, pricing, compliance, and issue gates', icon: '↗', color: '#6b46c1', badge: 'core', route: '/uw-workflow' },
  { slug: '__integration-center', title: 'Integration Center', desc: 'Credential-aware rating bureau, claims history, and document verification controls', icon: '⇄', color: '#1a365d', badge: 'core', route: '/integration-center' },
  { slug: '__agentic-underwriting', title: 'Agentic Underwriting', desc: 'AI triage for low-risk auto decisions and human underwriter escalations', icon: 'AI', color: '#805ad5', badge: 'ai', route: '/agentic-underwriting' },
  { slug: '__renewal-optimizer', title: 'Renewal Optimizer', desc: 'AI renewal probability predictions and retention action recommendations', icon: 'RO', color: '#744210', badge: 'ai', route: '/renewal-optimizer' },
  { slug: '__appetite-drift', title: 'Appetite Drift', desc: 'Monitor underwriting appetite drift across policy segments and loss-ratio signals', icon: 'AD', color: '#c05621', badge: 'analytics', route: '/appetite-drift-monitor' },
