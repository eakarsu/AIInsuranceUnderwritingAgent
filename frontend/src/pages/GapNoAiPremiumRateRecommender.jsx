...
// Auto-generated page for: No AI premium-rate recommender

export default function GapNoAiPremiumRateRecommender() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-ai-premium-rate-recommender', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No AI premium-rate recommender</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No AI premium-rate recommender</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No AI premium-rate recommender'}
        </button>
      </form>
