...
// Auto-generated page for: Agentic underwriting automation handling simple cases and es

export default function CfAgenticUnderwritingAutomationHandling() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-agentic-underwriting-automation-handling', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Agentic underwriting automation handling simple cases and es</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Agentic underwriting automation handling simple cases and escalating complex ones with AI risk summaries.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Agentic underwriting automation handling simple cases and es'}
        </button>
      </form>
